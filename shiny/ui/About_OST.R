           ...
           box(
              ...
              tabBox(width = 1400,
                     ...
                     tabPanel("Outline",
                              ...
                              p("1.5 - ", actionLink("link_to_tabpanel_sarrefs", "Reference Material")),
                              tags$h4("2  - ALOS Functionality"),
                              p("2.1 - ", actionLink("link_to_tabpanel_alos_kc_dow", "ALOS Kyoto & Carbon Mosaic download")),
                              p("2.1 - ", actionLink("link_to_tabpanel_alos_kc_pro", "ALOS Kyoto & Carbon Mosaic preparation")),
                              p("2.1 - ", actionLink("link_to_tabpanel_alos_kc_fnf", "ALOS Kyoto & Carbon FNF map preparation")),
